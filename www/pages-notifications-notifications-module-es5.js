...
module.exports = ".class1 {\n  float: left;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var NotificationsPage = /** @class */ (function () {
    ...
    NotificationsPage.prototype.ngOnInit = function () {
        var _this = this;
        this.auth.userData$.subscribe(function (res) { _this.authUser = res; console.log(typeof _this.authUser); });
        var email = { "attendee_email": this.authUser.user_email };
        this.subscription = this.webservice.notificationList(email).subscribe(function (res) { _this.list = res.result; console.log(_this.list); });
    };
    ...
    NotificationsPage.prototype.goTo = function (channel_name, start_date, end_date) {
        var now = moment__WEBPACK_IMPORTED_MODULE_7__();
        var date = moment__WEBPACK_IMPORTED_MODULE_7__["utc"](start_date).local();
    ...
    NotificationsPage.prototype.refreshList = function () {
        var _this = this;
